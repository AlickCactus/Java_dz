...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.recycleViewStagged);
        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL));
        recyclerView.setAdapter(new RecyclerViewAdapter(this, generateList()));
    }
    ...
    public ArrayList<ModelImage> generateList(){
        ArrayList<ModelImage> arrayList = new ArrayList<>();
        for (int i=0;i<image_urls.length;i++) {
            arrayList.add(new ModelImage(image_urls[i]));
        }
        return arrayList;
    }
